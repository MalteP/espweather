...
int ICACHE_FLASH_ATTR bmpInit( struct bmpdata* d )
 {
  ...
  d->ac3 = (int16_t) i2cReadRegister16(BMP180_ADDR, BMP180_REG_AC3);
  d->ac4 = i2cReadRegister16(BMP180_ADDR, BMP180_REG_AC4);
  d->ac5 = i2cReadRegister16(BMP180_ADDR, BMP180_REG_AC5);
  d->ac6 = i2cReadRegister16(BMP180_ADDR, BMP180_REG_AC6);
  d->b1 = (int16_t) i2cReadRegister16(BMP180_ADDR, BMP180_REG_B1);
  d->b2 = (int16_t) i2cReadRegister16(BMP180_ADDR, BMP180_REG_B2);
  d->mb = (int16_t) i2cReadRegister16(BMP180_ADDR, BMP180_REG_MB);
...
int ICACHE_FLASH_ATTR bmpRead( struct bmpdata* d )
 {
  ...
  x1 = (d->pressure / 256) * (d->pressure / 256);
  x1 = (x1 * 3038) / 65536;
  x2 = (-7357 * d->pressure) / 65536;
